                    ...
                    // alert(product.name);
                        ...
                        $('#table-body').append(`
                            <tr class="tr-item" id="tr-item-${product.id}">
                                ...
                                <td>
                                    <input type="number" name="cant[]"  max="${product.cantRestante}" step="1" id="select-cant-${product.id}" onkeyup="getSubtotal(${product.id})" onchange="getSubtotal(${product.id})" onkeypress="return filterFloat(event,this);" style="text-align: right" class="form-control text" required>
                                </td>
                    ...
                    // alert(product.name);
                        ...
                        $('#table-bodyMenu').append(`
                            <tr class="tr-item" id="tr-item-menu-${product.id}">
                                ...
                                <td>
                                    <input type="number" name="cant[]"  step="1" id="select-cant-menu-${product.id}" onkeyup="getSubtotalMenu(${product.id})" onchange="getSubtotalMenu(${product.id})" onkeypress="return filterFloat(event,this);" style="text-align: right" class="form-control text" required>
                                </td>
