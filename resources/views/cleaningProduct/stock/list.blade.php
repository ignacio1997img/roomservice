                    ...
                    <td>
                        ...
                        <div style="display: flex">
                            ...
                            <div>
                                ...
                                <small>Presentación: </small>{{ $item->article->presentation }} <br>
                                <small>Categoría: </small>{{ $item->article->category->name }} 
                            </div>
                        </div>
                    </td>
                    {{-- <td>{{ $item->article->name }}</td> --}}
                    <td style="text-align: right"><small>{{ number_format($item->stock, 2, ',', '.') }}</small></td>
                    <td style="text-align: right"><small>{{ number_format($item->price, 2, ',', '.') }}</small></td>
                    <td style="text-align: right"><small>Bs. {{ number_format(($item->stock*$item->price), 2, ',', '.') }}</small></td>
