...
@if (auth()->user()->hasPermission('browse_cleaningproductsstockarticle'))
                    ...
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-4" style="padding: 0px">
                            <h1 id="titleHead" class="page-title">
                                <i class="fa-brands fa-shopify"></i> Stock Disponble Para Limpieza
                            </h1>
...
@section('javascript')
    <script>
        ...
        function list(page = 1){
            ...
            let url = '{{ url("admin/cleaningproducts/stock/ajax/list") }}';
            // alert(1)
